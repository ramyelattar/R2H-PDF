...
#ifndef R2H-PDF_FITZ_FONT_H
#define R2H-PDF_FITZ_FONT_H
...
/**
	Install functions to allow R2H-PDF to request fonts from the
	system.
...
/**
	...
	configuration in which R2H-PDF is built.
