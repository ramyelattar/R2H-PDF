...
#ifndef R2H-PDF_FITZ_EXPORT_H
#define R2H-PDF_FITZ_EXPORT_H

/*
 * Support for building/using R2H-PDF DLL on Windows.
 *
 * When compiling code that uses R2H-PDF DLL, FZ_DLL_CLIENT should be defined.
 *
 * When compiling R2H-PDF DLL itself, FZ_DLL should be defined.
 */
