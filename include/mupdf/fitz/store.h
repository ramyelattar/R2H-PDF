...
#ifndef R2H-PDF_FITZ_STORE_H
#define R2H-PDF_FITZ_STORE_H
...
/**
	...
	R2H-PDF stores decoded "objects" into a store for potential reuse.
	If the size of the store gets too big, objects stored within it
	can be evicted and freed to recover space. When R2H-PDF comes to
