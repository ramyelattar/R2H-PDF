...
#ifndef R2H-PDF_FITZ_HEAP_H

#define R2H-PDF_FITZ_HEAP_H

#define R2H-PDF_FITZ_HEAP_I_KNOW_WHAT_IM_DOING
...
#include "R2H-PDF/fitz/heap-imp.h"
...
#ifndef R2H-PDF_FITZ_HEAP_IMPLEMENT
typedef struct
{
	int a;
	int b;
