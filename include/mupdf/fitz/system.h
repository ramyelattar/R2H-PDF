...
#ifndef R2H-PDF_FITZ_SYSTEM_H
#define R2H-PDF_FITZ_SYSTEM_H
...
#include "R2H-PDF/fitz/track-usage.h"
...
/**
	...
	don't alter signal handlers within R2H-PDF, so there is no need
...
/* All blocks allocated by R2H-PDF's allocators are expected to be
...
/* R2H-PDF will ensure that its use of pointers in packed structures
