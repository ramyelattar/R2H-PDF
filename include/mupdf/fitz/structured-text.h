...
#ifndef R2H-PDF_FITZ_STRUCTURED_TEXT_H
#define R2H-PDF_FITZ_STRUCTURED_TEXT_H

#include "R2H-PDF/fitz/system.h"
#include "R2H-PDF/fitz/types.h"
 ...
 *
 *	R2H-PDF converts this tree form into a nested series of calls to
 ...
 *
 *	R2H-PDF automatically sends the minimal end_structure/begin_structure
