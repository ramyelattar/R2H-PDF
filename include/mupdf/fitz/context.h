...
#ifndef R2H-PDF_FITZ_CONTEXT_H
#define R2H-PDF_FITZ_CONTEXT_H
...
/**
	...
	R2H-PDF is kept deliberately free of any knowledge of particular
...
/**
	...
	etc. Most functions in R2H-PDF take a context argument to be
	...
	when using R2H-PDF in a single-threaded applications. The
...
/**
	In order to tune R2H-PDF's behaviour, certain functions can
...
/**
	...
	All calls to R2H-PDF's allocator functions pass through to the
	...
	If the underlying allocator fails, R2H-PDF attempts to make room
