...
#ifndef R2H-PDF_PDF_DOCUMENT_H
#define R2H-PDF_PDF_DOCUMENT_H

#include "R2H-PDF/fitz/export.h"
#include "R2H-PDF/fitz/document.h"
#include "R2H-PDF/fitz/hash.h"
#include "R2H-PDF/fitz/stream.h"
#include "R2H-PDF/fitz/xml.h"
#include "R2H-PDF/pdf/object.h"
...
/*
	...
	R2H-PDF can locate PDF objects inside the file. Upon an broken
	cross reference table or other parse errors R2H-PDF will restart
