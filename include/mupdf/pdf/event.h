...
#ifndef R2H-PDF_PDF_EVENT_H
#define R2H-PDF_PDF_EVENT_H

#include "R2H-PDF/pdf/document.h"

/*
	Document events: the objects via which R2H-PDF informs the calling app
	of occurrences emanating from the document, possibly from user interaction
	or javascript execution. R2H-PDF informs the app of document events via a
	callback.
*/
...
/*
	...
	structure are owned by R2H-PDF and need not be freed by the
	caller.
*/
...
/*
	...
	are owned by R2H-PDF and need not be freed by the caller.
*/
