 ...
 * link R2H-PDF into an app that either calls harfbuzz
 ...
 * harfbuzz instances.
 *
 * In order to ensure that allocations throughout R2H-PDF
 ...
 * outside R2H-PDF calling harfbuzz while R2H-PDF
