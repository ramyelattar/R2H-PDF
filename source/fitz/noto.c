...
enum
{
	R2H-PDF_SCRIPT_MUSIC = UCDN_LAST_SCRIPT+1,
	R2H-PDF_SCRIPT_MATH,
	R2H-PDF_SCRIPT_SYMBOLS,
	R2H-PDF_SCRIPT_SYMBOLS2,
	R2H-PDF_SCRIPT_EMOJI,
	R2H-PDF_SCRIPT_CJKV
};
...
{
	return search_by_script_lang(size, NULL, R2H-PDF_SCRIPT_MATH, FZ_LANG_UNSET);
}

const unsigned char *
fz_lookup_noto_music_font(fz_context *ctx, int *size)
{
	return search_by_script_lang(size, NULL, R2H-PDF_SCRIPT_MUSIC, FZ_LANG_UNSET);
}

const unsigned char *
fz_lookup_noto_symbol1_font(fz_context *ctx, int *size)
{
	return search_by_script_lang(size, NULL, R2H-PDF_SCRIPT_SYMBOLS, FZ_LANG_UNSET);
}

const unsigned char *
fz_lookup_noto_symbol2_font(fz_context *ctx, int *size)
{
	return search_by_script_lang(size, NULL, R2H-PDF_SCRIPT_SYMBOLS2, FZ_LANG_UNSET);
}

const unsigned char *
fz_lookup_noto_emoji_font(fz_context *ctx, int *size)
{
	return search_by_script_lang(size, NULL, R2H-PDF_SCRIPT_EMOJI, FZ_LANG_UNSET);
}
