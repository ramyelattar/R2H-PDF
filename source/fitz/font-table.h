...
#ifndef TOFU_SYMBOL
FONT(noto,	NotoSansMath_Regular_otf,	"Noto Sans Math",	R2H-PDF_SCRIPT_MATH,	FZ_LANG_UNSET,	NO_SUBFONT,	REGULAR)
FONT(noto,	NotoMusic_Regular_otf,		"Noto Music",		R2H-PDF_SCRIPT_MUSIC,	FZ_LANG_UNSET,	NO_SUBFONT,	REGULAR)
FONT(noto,	NotoSansSymbols_Regular_otf,	"Noto Sans Symbols",	R2H-PDF_SCRIPT_SYMBOLS,	FZ_LANG_UNSET,	NO_SUBFONT,	REGULAR)
ALIAS(noto,	NotoSansSymbols_Regular_otf,	"Noto Sans Symbols",	UCDN_SCRIPT_BRAILLE,	FZ_LANG_UNSET,	NO_SUBFONT,	REGULAR)
FONT(noto,	NotoSansSymbols2_Regular_otf,	"Noto Sans Symbols2",	R2H-PDF_SCRIPT_SYMBOLS2,	FZ_LANG_UNSET,	NO_SUBFONT,	REGULAR)
FONT(noto,	NotoEmoji_Regular_ttf,		"Noto Emoji",		R2H-PDF_SCRIPT_EMOJI,	FZ_LANG_UNSET,	NO_SUBFONT,	REGULAR)
#endif
