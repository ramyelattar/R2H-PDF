...
static void app_alert(js_State *J)
{
	...
	oDoc can only point to the current document (or not be passed). When R2H-PDF
...
#ifdef CLUSTER
	js_dostring(js->imp,
"var R2H-PDFOldDate = Date\n"
"Date = function() { return new R2H-PDFOldDate(298252800000); }\n"
"Date.now = function() { return 298252800000; }\n"
"Date.UTC = function() { return 298252800000; }\n"
"Date.parse = R2H-PDFOldDate.parse;\n"
