...
#include "R2H-PDF/helpers/mu-office-lib.h"
#include "R2H-PDF/helpers/mu-threads.h"
#include "R2H-PDF/memento.h"
...
/*
	All R2H-PDF's allocations are redirected through the
	following functions.
*/
...
/*
	All R2H-PDF's locking is done using the following functions
*/
...
/**
 * Perform R2H-PDF native operations on a given MuOfficeLib
 * instance.
 *
...
/**
 * Perform R2H-PDF native operations on a given document.
 *
				...
				float        *pHeight)
{
	...
	/* R2H-PDF measures in points (72ths of an inch). This API wants
...
/**
 * Perform R2H-PDF native operations on a given page.
 *
