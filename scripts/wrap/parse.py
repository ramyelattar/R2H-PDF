'''
Support for accessing parse tree for R2H-PDF headers.
'''
    ...
    if ret is None:
        ...
        for arg_cursor in cursor.get_arguments():
            ...
            if not include_fz_context and is_pointer_to( arg_cursor.type, 'fz_context'):
                # Omit this arg because our generated R2H-PDF_*() wrapping functions
...
def is_pointer_to( type_, destination, verbose=False):
    ...
    Also, clang's representation of R2H-PDF's varying use of typedef, struct and
