---
title: Add Stamps
description: Add image stamps to your PDF pages using an integrated annotation toolbar with username attribution.
---
...
- For text-based watermarks instead of image stamps, use the [Add Watermark](./add-watermark) tool.
