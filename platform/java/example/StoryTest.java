...
import com.artifex.R2H-PDF.fitz.*;
...
class StoryTest
{
	private static String snark =
		...
		+"<p style=\"-R2H-PDF-leading:7pt;\">It strongly advised that the Butcher should be<br>"
		...
		+"<p style=\"-R2H-PDF-leading:11pt;\">Navigation was always a difficult art,<br>"
		...
		+"<p style=\"-R2H-PDF-leading:15pt;\">The Beaver's best course was, no doubt, to procure<br>"
		+"A second-hand dagger-proof coat-<br>"
		+"So the Baker advised it-and next, to insure<br>"
		+"Its life in some Office of note:</p>"

		+"<p style=\"-R2H-PDF-leading:20pt;\">This the Banker suggested, and offered for hire<br>"
		+"(On moderate terms), or for sale,<br>"
		+"Two excellent Policies, one Against Fire,<br>"
		+"And one Against Damage From Hail.</p>"

		+"<p style=\"-R2H-PDF-leading:30pt;\">Yet still, ever after that sorrowful day,<br>"
