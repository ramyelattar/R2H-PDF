...
void win_install(void)
{
	...
	OPEN_KEY(software, "Classes", &classes);
	{
		OPEN_KEY(classes, "R2H-PDF", &R2H-PDF);
		{
			...
			{
				SET_VALUE(open, "FriendlyAppName", "R2H-PDF");
		...
		OPEN_KEY(classes, ".fb2", &dotfb2);
		{
			...
			{
				SET_VALUE(pdf_progids, "R2H-PDF", "");
				SET_VALUE(xps_progids, "R2H-PDF", "");
				SET_VALUE(cbz_progids, "R2H-PDF", "");
				SET_VALUE(epub_progids, "R2H-PDF", "");
				SET_VALUE(fb2_progids, "R2H-PDF", "");
			}
