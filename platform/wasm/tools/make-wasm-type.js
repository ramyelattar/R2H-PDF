// cat src/R2H-PDF.c | sed '/#include/d' | cpp | node gen-wasm-type.js

"use strict"

import fs from "fs"

console.log(`export default libR2H-PDF_wasm
declare function libR2H-PDF_wasm(Module: any): Promise<LibR2H-PDF>
declare const _brand: unique symbol
export type Pointer<B> = number & { readonly [_brand]: B }
export { libR2H-PDF_wasm }
interface LibR2H-PDF {
